...
TOTALTRAFFIC=False                                       # show graph for total traffic (all IPs)
IPVIEW=['10.100.22.101', '10.100.22.102']               # fill this list with the ips you want to check, if empty we will show all IPs
FILENAME='bangkok-access.log'
# graph types enabled:
GRAPHNORMAL=False
GRAPHROLLED=True
